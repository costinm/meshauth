...
// TODO: move tests from other packages here.
// Because this module only depends on stdlibs, e2e test are in ugate project
// for now.
...
func BenchmarkVerify(b *testing.B) {
	...
	x, y := elliptic.Unmarshal(elliptic.P256(), pubb)
